...
//定义调试输出模式
#define Debug_Mode_None  0 //关闭调试输出
#define Debug_Mode_TSDB  1 //调试信息写入 TSDB (FlashDB)
#define Debug_Mode_USBD  2 //调试信息输出到 USB CDC
#define Debug_Mode_LVGL  3 //调试信息输出到 LVGL 界面
